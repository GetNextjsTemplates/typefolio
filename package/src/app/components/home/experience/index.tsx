                        ...
                        <div className="flex flex-col max-w-3xl mx-auto px-4 sm:px-7 py-9 md:py-16 ">
                            {experienceData?.map((value: any, index: any) => {
                                return (
                                    <div
                                        key={index}
                                        className="flex flex-col gap-5 border-dashed border-b border-primary/10 last:border-b-0 pt-10 pb-10 first:pt-0 last:pb-0">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2.5 border border-primary/10 rounded-lg py-1.5 px-3">
                                                ...
                                                <p className="text-primary ">{value?.startYear} – {value?.endYear} · {value?.location}</p>
                                            </div>
                                        </div>
                                        <ul>
