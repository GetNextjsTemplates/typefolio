#### # Typefolio Web Template for CV's, Bio Data
🌏[Live Demo](https://typefolio-nextjs.vercel.app/) |📥[Download](https://github.com/GetNextjsTemplates/typefolio) |👉 [Check Out Next.js Templates](https://getnextjstemplates.com/)

<a target="_blank" href="https://getnextjstemplates.com/products/typefolio-nextjs-template">
  <img src="https://getnextjstemplates.com/images/template-images/typefolio-nextjs-template.webp" />
</a>
...
Welcome to the **Typefolio Web Template for CV's, Bio Data**! This guide will walk you through the installation and setup process, so you can get started with building your custom web page in no time.
...
```bash
git clone https://github.com/GetNextjsTemplates/typefolio.git
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/GetNextjsTemplates/typefolio.git&root-directory=package)
